...
PDFJS.imageResourcesPath = './reader/images/';
...
var DEFAULT_SCALE = 'auto';//'page-width';
var UNKNOWN_SCALE = 0;
...
function webViewerLoad(evt) {
	try
	{
		var s1=document.getElementById("sidebarContainer").clientWidth;
		var s2=document.getElementById("mainContainer").clientWidth;
		if (s1*2 >= s2 )
		{
			document.getElementById("sidebarToggle").classList.remove('toggled');
			document.getElementById("outerContainer").classList.remove('sidebarOpen');
		}
	}catch(e){
		;
	}
